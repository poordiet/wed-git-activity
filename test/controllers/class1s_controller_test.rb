...
class Class1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class1" do
    assert_difference('Class1.count') do
      post class1s_url, params: { class1: { department: @class1.department, name: @class1.name, number: @class1.number } }
    end
  ...
  test "should update class1" do
    patch class1_url(@class1), params: { class1: { department: @class1.department, name: @class1.name, number: @class1.number } }
