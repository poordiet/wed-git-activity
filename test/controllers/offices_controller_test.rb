...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { professor_id: @office.professor_id, room_num: @office.room_num } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { professor_id: @office.professor_id, room_num: @office.room_num } }
